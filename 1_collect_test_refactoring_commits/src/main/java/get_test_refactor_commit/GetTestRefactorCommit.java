package get_test_refactor_commit;
...
public class GetTestRefactorCommit {
    ...
    static final String CSV_OUTPUT_FILE = "src/main/resources/output/test_refactor_commits_add.csv";
    static final String CSV_ERROR_REPOSITORY_FILE = "src/main/resources/error/test_refactor_commits_add.csv";
    static final String CSV_ERROR_COMMIT_FILE = "src/main/resources/error/test_refactor_commits_add.csv";
    ...
    private static void processCommit(Git git, RevCommit commit, Repository repository, String repoDIr, String repositoryURL) {
        ...
        if ((checkChangeFile(changedFiles) || isTestFileName(changedFiles)) && checkCommitMessage(message)){
            writeCommitToCSV(repoName, repositoryURL, commitID, parentCommitID, commitURL, message, commitDate, author, changedFiles);
        }
    }

    public static boolean isTestFileName(List<String> changedFiles) {
